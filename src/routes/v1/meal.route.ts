 ...
 * tags:
 *   name: meals
 *   description: meals management and retrieval
 */
 ...
 *     description: Only verified chefs can create a meal.
 *     tags: [meals]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 ...
 *     description: Only chefs can retrieve all meals.
 *     tags: [meals]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *           minimum: 1
 *         default: 10
 *         description: Maximum number of mealss
 *       - in: query
 *         name: page
 *         schema:
 *           type: integer
 ...
 *   get:
 *     summary: Get a meals
 *     description: Logged in chefs and chefs can query a meals.
 *     tags: [meals]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *
 *   patch:
 *     summary: Update a meals
 *     description: Logged in chefs can only update their own meals.
 *     tags: [meals]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in chefs can delete only their mealss.
 *     tags: [meals]
 *     security:
 *       - bearerAuth: []
 *     parameters:
